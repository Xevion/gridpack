...
const segmentGroupRecipe = defineSlotRecipe({
	className: "segmentGroup",
	slots: ["root", "indicator", "item", "itemText", "itemControl"],
	base: {
		root: {
			display: "inline-flex",
			alignItems: "center",
...
const selectControlRecipe = defineSlotRecipe({
...
const switchControlRecipe = defineSlotRecipe({
